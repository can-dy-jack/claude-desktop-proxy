...
const messages: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "config.clearInput": "清除输入",
    "config.showSecret": "显示",
    "config.hideSecret": "隐藏",
    ...
    "runtime.running": "运行中",
    "runtime.stopped": "已停止",
    "runtime.statusHintRunning": "代理已就绪，可正常转发请求",
    "runtime.statusHintStopped": "代理未运行，请点击“启动”",
  ...
  "en-US": {
    ...
    "config.clearInput": "Clear input",
    "config.showSecret": "Show",
    "config.hideSecret": "Hide",
    ...
    "runtime.statusHintRunning": "Proxy is ready and forwarding requests",
    "runtime.statusHintStopped": "Proxy is not running. Click Start",
